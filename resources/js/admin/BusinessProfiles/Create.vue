    ...
    <div class="relative shadow-md sm:rounded-lg bg-white py-4">
      ...
      <form class="px-4 md:px-6 lg:px-8" @submit.prevent="addUpdateForm()">
        ...
        <div class="text-sm font-medium text-gray-500 border-b border-gray-200">
          <ul
            class="block sm:flex flex-wrap mb-2 overflow-x-auto gap-1 space-y-2 md:space-y-0"
          >
            <li class="mr-2">
              <a
                @click.prevent="activeTab = 'registration-package'"
                href="#"
                :class="[
            ...
            <li class="mr-2">
              <a
                @click.prevent="activeTab = 'user-profile'"
                href="#"
                :class="[
                  'inline-block rounded font-FuturaMdCnBT px-5 py-2 lg:text-lg md:text-base sm:text-base text-base hover:bg-blue-100 border border-primary text-center hover:border-blue-500 hover:text-blue-600',
            ...
            <li class="mr-2">
              <a
                @click.prevent="activeTab = 'social_media'"
                href="#"
                :class="[
                  'inline-block rounded font-FuturaMdCnBT px-5 py-2 lg:text-lg md:text-base sm:text-base text-base hover:bg-blue-100 border border-primary text-center hover:border-blue-500 hover:text-blue-600',
        ...
        >
          <div class="relative z-0 w-full group">
            ...
            <input
              ...
              placeholder=" "
              @input="updateForm('company_name', $event.target.value)"
              :value="
                form && form.has('company_name') ? form.get('company_name') : ''
              "
            />

            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('company_name')"
              v-text="validationErros.get('company_name')"
            ></p>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <input
              ...
              class="can-exp-input w-full block border border-gray-300 rounded"
              placeholder=" "
              @input="updateForm('company_email', $event.target.value)"
              :value="
                form && form.has('company_email')
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('company_email')"
              v-text="validationErros.get('company_email')"
            ></p>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('website')"
              v-text="validationErros.get('website')"
            ></p>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <input
              ...
              class="can-exp-input w-full block border border-gray-300 rounded"
              placeholder=" "
              @input="updateForm('company_phone', $event.target.value)"
              :value="
                form && form.has('company_phone')
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('company_phone')"
              v-text="validationErros.get('company_phone')"
            ></p>
          </div>
          <!-- <div class="relative z-0 w-full group">
          ...
          <div class="relative z-0 w-full group">
            ...
            <textarea
              ...
              class="can-exp-input w-full block border border-gray-300 rounded"
              placeholder=" "
              @input="updateForm('short_description', $event.target.value)"
              v-text="
                form && form.has('short_description')
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('short_description')"
              v-text="validationErros.get('short_description')"
            ></p>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <textarea
              ...
              v-text="
                form && form.has('description') ? form.get('description') : ''
              "
            ></textarea>
          ...
          <div class="relative z-0 w-full group">
            ...
            <textarea
              ...
              class="can-exp-input w-full block border border-gray-300 rounded"
              placeholder=" "
              @input="updateForm('mailing_address', $event.target.value)"
              v-text="
                form && form.has('mailing_address')
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('mailing_address')"
              v-text="validationErros.get('mailing_address')"
            ></p>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <textarea
              ...
              class="can-exp-input w-full block border border-gray-300 rounded"
              placeholder=" "
              @input="updateForm('keywords', $event.target.value)"
              v-text="form && form.has('keywords') ? form.get('keywords') : ''"
            ></textarea>

            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('keywords')"
              v-text="validationErros.get('keywords')"
            ></p>
          </div>
        </div>
        <div>
          <div
            class="grid grid-cols-1 md:grid-cols-2 gap-3 py-3 mb-6"
            :class="activeTab == 'categories' ? 'block' : 'hidden'"
          >
            <p
              class="mt-2 text-sm text-red-400 col-span-2"
              v-if="validationErros.has('business_categories_id')"
              v-text="validationErros.get('business_categories_id')"
            ></p>
            <div
            ...
            >
              <input
                :id="`business-category-${business_category.id}`"
                type="checkbox"
              ...
              />
              <label
                :for="`business-category-${business_category.id}`"
        ...
        >
          <div class="relative z-0 w-full group">
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('registration_package_id')"
              v-text="validationErros.get('registration_package_id')"
            ></p>
          </div>
          <div class="relative z-0 w-full group">
  ...
  />
        ...
        >
          ...
          <div class="relative z-0 w-full group">
            ...
            <p
              ...
              v-text="validationErros.get('password_confirmation')"
            ></p>
          </div>
        </div>
        ...
        >
          <div class="relative z-0 w-full group">
            <label for="media_title"
              >Title of the media section (Max.10 words)</label
            >
            <textarea
              name="media_title"
              id="media_title"
              class="can-exp-input w-full block border border-gray-300 rounded"
              placeholder=" "
              @input="updateForm('media_title', $event.target.value)"
              v-text="
                form && form.has('media_title') ? form.get('media_title') : ''
              "
            ></textarea>

            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('media_title')"
              v-text="validationErros.get('media_title')"
            ></p>
          </div>
          <div class="relative z-0 w-full group">
            <label for="media_description"
              >Description of the media section (Max.50 words)</label
            >
            <textarea
              ...
              class="can-exp-input w-full block border border-gray-300 rounded"
              placeholder=" "
              @input="updateForm('media_description', $event.target.value)"
              v-text="
                form && form.has('media_description')
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('media_description')"
              v-text="validationErros.get('media_description')"
            ></p>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <input
              ...
              class="can-exp-input w-full block border border-gray-300 rounded"
              placeholder=" "
              @input="updateForm('video', $event.target.value)"
              :value="form && form.has('video')
                  ? form.get('video')
                  : ''"
            />
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('video')"
              v-text="validationErros.get('video')"
            ></p>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <FilePond
              ...
              credits="false"
              :labelIdle="`<span class='cursor-pointer'>Drag and drop or browse</span>`"
              ref="logo"
              v-bind:files="files"
              @init="handleLogoInit"
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('logo')"
              v-text="validationErros.get('logo')"
            ></p>
          </div>
        ...
        >
          <div class="relative z-0 w-full group">
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('facebook')"
              v-text="validationErros.get('facebook')"
            ></p>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('twitter')"
              v-text="validationErros.get('twitter')"
            ></p>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('youtube')"
              v-text="validationErros.get('youtube')"
            ></p>
          </div>
          <div class="relative z-0 w-full group">
            ...
            <p
              class="mt-2 text-sm text-red-400"
              v-if="validationErros.has('linkedin')"
              v-text="validationErros.get('linkedin')"
            ></p>
          </div>
        </div>
